<?php 
	...
	class Permisos extends Controllers{
		...
		public function getPermisos(String $idRol)
			{
				$idRol = intval($idRol);
				if ($idRol > 0) {
                    ...
                    $arrPermisosIdRol = array('idrol' => $idRol);
                    ...
                    $arrPermisosIdRol['modulos']=$arrModulos;
                    $html = getModal("modalPermisosRol",$arrPermisosIdRol);
                    // dep($arrPermisosIdRol);
